...
procedure Mines_Process();
var
	i, j, owner: byte; x, y, x2, y2, v1x, v1y, v2x, v2y, a, r: single;
begin
									...
									begin
										...
										if IsInRange(j, Mines.Mine[i].X + v1x*Mines.PS * r / Mines.RMax, Mines.Mine[i].Y + v1y*Mines.PS * r / Mines.RMax, r, false) then begin //TODO: false?
											...
											if r > Mines.RMin+5 then begin
												...
												a:=arccos((v1x*v2x + v1y*v2y) / Sqrt((v1x*v1x + v1y*v1y)*(v2x*v2x + v2y*v2y)));
											...
											if i = Mines.MaxMineID then begin
												for Mines.MaxMineID := MAX_MINES downto 1 do
													if Mines.Mine[Mines.MaxMineID].placed then begin
														break;
													end;
											end;
											break;
